WITH MaritalView AS (SELECT "CustomerMaritalStatus",
                     ...
                     GROUP BY ("CustomerMaritalStatus", extract(year FROM "CustomerDateOfBirth"),
                               "ProductCategory"))
SELECT *
FROM MaritalView
GROUP BY CUBE ("CustomerMaritalStatus", "CustomerYearOfBirth", "ProductCategory", "AverageSpending");